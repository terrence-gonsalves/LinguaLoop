        ...
        <ThemedView style={styles.contentContainer}>
          <ThemedView>
            ...
            <ThemedView>
              ...
              <ThemedView style={styles.informationWrapper}>
                  <ThemedText style={styles.informationTitle}>Progression</ThemedText>
                  <ThemedView style={styles.informationContentWrapper}>
                    <ThemedText>Current Level</ThemedText>
                    <ThemedText>2</ThemedText>
                  </ThemedView>
                  <ThemedView style={styles.levelWrapper}>
                    <ThemedView style={[styles.levelContent, {height: 25}]}></ThemedView>
                    <ThemedView style={[styles.levelContent, {height: 50}]}></ThemedView>
                    <ThemedView style={[styles.levelContent, {height: 75}]}></ThemedView>
                    <ThemedView style={[styles.levelContent, {height: 100}]}></ThemedView>
                    <ThemedView style={[styles.levelContent, {height: 125}]}></ThemedView>
                    <ThemedView style={[styles.levelContent, {height: 150}]}></ThemedView>
                    <ThemedView style={[styles.levelContent, {height: 175}]}></ThemedView>
                  </ThemedView>
              </ThemedView>
            </ThemedView>
          </ThemedView>
